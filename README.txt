디지털 사이니지 제작기 V1.5.2 · CONTACT COLOR
...
V1.5.2 · CONTACT COLOR
공지사항의 관련 문의 배경을 지정 이미지에서 추출한 옅은 청회색으로 맞췄습니다.
- 진한 파란색 문의 배경을 반투명 청회색 `rgba(34,73,128,.105)`로 교체
- 흰색 배경에서 지정 이미지의 약 `rgb(232,236,242)`로 표시
- 브라우저에 이전 프리셋 상태가 저장돼 있어도 새 색상으로 자동 교정
